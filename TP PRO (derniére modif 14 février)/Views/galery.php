<?php
require "../Controllers/galery_controller.php";
?>
...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/style-galery.css">
...
<body class="body">
    ...
    <div class="row align-content-center justify-content-center" id="form">
        ...
        <form class="col-10 d-flex flex-wrap align-content-center justify-content-center m-3" action="galery.php" method="post" enctype="multipart/form-data">

            <div class="formPreviewPicture col-xl-10 col-lg-10 col-md-10 col-sm-12 m-0 text-center">
